...
main     → 배포용 (PR 머지만 허용)
develop  → 통합 브랜치
feature/week2-* → Week 2 AI 파이프라인 작업
feature/week3-* → Week 3 알림 & 프론트엔드 작업
feature/week4-* → Week 4 배포 & 검증 작업
```

상세 브랜치 계획: [`.claude/github.md`](.claude/github.md)
...
- [x] README.md 작성 및 GitHub push
- [x] 개발 워크플로우 개선 (브랜치 전략, Velog 연계, Skill 가이드)
...
- [x] api-server news CRUD (NewsArticle+NewsSummary) + n8n 워크플로우 JSON
